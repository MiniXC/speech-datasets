# THIS IS AN ADAPTED VERSION OF THE ORIGINAL LIBRISPEECH DATASET, WHICH CAN BE FOUND HERE:
# huggingface.co/datasets/librispeech_asr
# this version is adapted to work with the speech_datasets library by returning the path to the audio file only
...
class LibrispeechASR(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        LibrispeechASRConfig(
            name="all", description="Combined clean and other dataset."
        ),
    ]
            ...
            features=datasets.Features(
                {
                    ...
                    "speaker": datasets.Value("int64"),
                    "chapter": datasets.Value("int64"),
